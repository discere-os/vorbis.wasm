# @discere-os/vorbis.wasm

WebAssembly port of libvorbis - Ogg Vorbis audio encoding and decoding library with SIMD optimization and comprehensive TypeScript interface.

[![CI/CD](https://github.com/discere-os/discere-nucleus/actions/workflows/vorbis-wasm-ci.yml/badge.svg)](https://github.com/discere-os/discere-nucleus/actions)
[![JSR](https://jsr.io/badges/@discere-os/vorbis.wasm)](https://jsr.io/@discere-os/vorbis.wasm)
[![npm version](https://badge.fury.io/js/@discere-os%2Fvorbis.wasm.svg)](https://badge.fury.io/js/@discere-os%2Fvorbis.wasm)
